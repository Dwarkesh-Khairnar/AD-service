...
//   return (
//     <>
//       <header className="bg-white p-3 px-3 flex justify-between items-center">
//         <div>Logo</div>
//         <div>
//           <ul className="flex gap-4 ">
//             <li className="hidden md:block hover:text-red-600">Services</li>
//             <li className="hidden md:block hover:text-red-600">Plans</li>
//             <li className="hidden md:block hover:text-red-600">
//               Schedul meeting
//             </li>
//           </ul>
//         </div>
...
//           <button
//             href="#"
//             className=" bg-yellow-500 hover:bg-amber-600 text-white py-2 px-3 rounded-bl-md"
//           >
//             + New
//           </button>
//           <div className="block md:hidden mr-0 m-2 w-6 " onClick={showsidenav}>
//             {visible}
...
//             <li className=" my-4 hover:text-red-600 text-amber-50">Services</li>
//             <li className=" my-4 hover:text-red-600">Plans</li>
//             <li className=" my-4 hover:text-red-600 text-amber-50">########</li>
//             <li className=" my-4 hover:text-red-600">Schedul meeting</li>
//           </ul>
//           <hr className=" text-blue-100" />
//           <ul className=" ml-20 mt-10 ">
//             <li className=" text-amber-50  hover:text-red-600">Dashbord</li>
//           </ul>
//         </div>
//       </div>
//     </>
