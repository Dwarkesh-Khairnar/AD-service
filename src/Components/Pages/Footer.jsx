...
setYear(new Date().getFullYear())
  ...
  <footer className="bg-[#071025] text-[#e9f6ff] pt-14 pb-8 px-10">
    <div className="md:flex gap-20 max-w-275 m-auto md:flex-row flex-col md:m-0 mt-5">
      ...
      <div className="md:flex gap-20 max-w-275 m-auto md:flex-row flex-col md:m-0 mt-5">
        <div className="flex-1 min-w-55 products">
        ...
        <div className="flex-1 min-w-55 support md:m-0 mt-5">
    ...
    <div className=" border-t-2 border-[#ffffff0f] mt-12 pt-15">
        <div className="flex gap-10 max-w-275 m-auto justify-between align-middle">
